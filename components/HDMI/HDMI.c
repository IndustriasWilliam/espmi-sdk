...
#define HDMI_BRIDGE_PCLK     (27.5 * 1000 * 1000)
...
__attribute__((section(".force_fast"))) static bool OnVSYNCCallBack(esp_lcd_panel_handle_t panel, const esp_lcd_rgb_panel_event_data_t *event_data, void *user_data)
{
...
static esp_err_t HDMI_BRIDGE_Init(void){
	...
	err |= ESPMI_I2CWriteByte(HDMI_ADDRESS >> 1, HDMI_BRIDGE_CTL_3_MODE, 0xf0);
...
static esp_lcd_panel_handle_t HDMI_InitRGBBus(lv_disp_drv_t* disp_drive, _Bool refresh_on_demand, esp_lcd_rgb_panel_vsync_cb_t vsync_callback, const void* user_data){
    ...
    esp_lcd_rgb_panel_config_t panel_config = {
        ...
        .num_fbs = 2,
        .bounce_buffer_size_px = 6 * LCD_H_RES,
