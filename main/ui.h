...
LV_IMG_DECLARE(ui_img_text_bg_left_png);    // assets\text_bg_left.png
LV_IMG_DECLARE(ui_img_text_bg_center_png);    // assets\text_bg_center.png
LV_IMG_DECLARE(ui_img_text_bg_right_png);    // assets\text_bg_right.png
